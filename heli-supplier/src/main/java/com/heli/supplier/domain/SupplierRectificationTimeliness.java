...
/**
 * 产品技术问题整改及时性对象 supplier_rectification_timeliness
 * 
 * @author wll
 * @date 2025-03-05
 */
@Data
@TableName(value = "supplier_rectification_timeliness")
public class SupplierRectificationTimeliness implements Serializable
{
    @Serial
    @ExcelIgnore
