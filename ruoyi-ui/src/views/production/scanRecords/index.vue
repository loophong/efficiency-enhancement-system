  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="门架型号" prop="gantryModel">
        <el-input
          v-model="queryParams.gantryModel"
          placeholder="请输入门架型号"
          clearable
          @keyup.enter="handleQuery"
        />
      ...
      <el-form-item label="OK数量" prop="okQuantity">
        <el-input
          v-model="queryParams.okQuantity"
          placeholder="请输入OK数量"
          clearable
          @keyup.enter="handleQuery"
        />
      ...
      <el-form-item label="自动重新报工时间" prop="autoReworkTime">
        <el-date-picker clearable
          v-model="queryParams.autoReworkTime"
          type="date"
          value-format="YYYY-MM-DD"
      ...
      <el-form-item label="SAP返回标记" prop="sapReturnFlag">
        <el-input
          v-model="queryParams.sapReturnFlag"
          placeholder="请输入SAP返回标记"
          clearable
          @keyup.enter="handleQuery"
        />
      </el-form-item>
      <el-form-item label="SAP报工返回信息" prop="sapWorkorderReturnInfo">
        <el-input
          v-model="queryParams.sapWorkorderReturnInfo"
          placeholder="请输入SAP报工返回信息"
          clearable
          @keyup.enter="handleQuery"
        />
      </el-form-item>
      <el-form-item label="重发收货时间" prop="resendReceiptTime">
        <el-date-picker clearable
          v-model="queryParams.resendReceiptTime"
          type="date"
          value-format="YYYY-MM-DD"
      ...
      <el-form-item label="SAP收货返回消息" prop="sapReceiptReturnMessage">
        <el-input
          v-model="queryParams.sapReceiptReturnMessage"
          placeholder="请输入SAP收货返回消息"
          clearable
          @keyup.enter="handleQuery"
        />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          icon="Plus"
          @click="handleAdd"
          v-hasPermi="['production:scanRecords:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['production:scanRecords:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['production:scanRecords:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          icon="Download"
          @click="handleExport"
          v-hasPermi="['production:scanRecords:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="scanRecordsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['production:scanRecords:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['production:scanRecords:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="scanRecordsRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="重发收货时间" prop="resendReceiptTime">
          <el-date-picker clearable
            v-model="form.resendReceiptTime"
            type="date"
            value-format="YYYY-MM-DD"
            placeholder="请选择重发收货时间">
          </el-date-picker>
...
import { listScanRecords, getScanRecords, delScanRecords, addScanRecords, updateScanRecords } from "@/api/production/scanRecords";
