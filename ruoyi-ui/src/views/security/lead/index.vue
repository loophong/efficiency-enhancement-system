<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="worksList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="完成结果" align="center" prop="q1CompletionResults" />
      <el-table-column label="得分" align="center" prop="q1Score" />
      <el-table-column label="二季度重点实施事项 	" align="center" prop="q2FocusImplementation" />
      <el-table-column label="完成结果" align="center" prop="q2CompletionResults" />
      <el-table-column label="得分" align="center" prop="q2Score" />
      <el-table-column label="三季度重点实施事项" align="center" prop="q3FocusImplementation" />
      <el-table-column label="完成结果" align="center" prop="q3CompletionResults" />
      <el-table-column label="得分" align="center" prop="q3Score" />
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="worksRef" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="单位名称" prop="unitName">
        ...
        <el-form-item label="现状及要因 " prop="currentStatusAndCauses">
          <el-input v-model="form.currentStatusAndCauses" placeholder="请输入现状及要因 " />
        </el-form-item>
        <el-form-item label="目标" prop="target">
        ...
        <el-form-item label="一季度重点实施事项 	" prop="q1FocusImplementation">
          <el-input v-model="form.q1FocusImplementation" placeholder="请输入一季度重点实施事项 	" />
        </el-form-item>
        <el-form-item label="完成结果" prop="q1CompletionResults">
          <el-input v-model="form.q1CompletionResults" placeholder="请输入完成结果" />
        </el-form-item>
        <el-form-item label="得分" prop="q1Score">
          <el-input v-model="form.q1Score" placeholder="请输入得分" />
        </el-form-item>
        <el-form-item label="二季度重点实施事项 	" prop="q2FocusImplementation">
          <el-input v-model="form.q2FocusImplementation" placeholder="请输入二季度重点实施事项 	" />
        </el-form-item>
        <el-form-item label="完成结果" prop="q2CompletionResults">
          <el-input v-model="form.q2CompletionResults" placeholder="请输入完成结果" />
        </el-form-item>
        <el-form-item label="得分" prop="q2Score">
          <el-input v-model="form.q2Score" placeholder="请输入得分" />
        </el-form-item>
        <el-form-item label="三季度重点实施事项" prop="q3FocusImplementation">
          <el-input v-model="form.q3FocusImplementation" placeholder="请输入三季度重点实施事项" />
        </el-form-item>
        <el-form-item label="完成结果" prop="q3CompletionResults">
          <el-input v-model="form.q3CompletionResults" placeholder="请输入完成结果" />
        </el-form-item>
        <el-form-item label="得分" prop="q3Score">
          <el-input v-model="form.q3Score" placeholder="请输入得分" />
        </el-form-item>
      </el-form>
      <template #footer>
...
import { listWorks, getWorks, delWorks, addWorks, updateWorks } from "@/api/security/works";
...
const data = reactive({
  ...
  rules: {
    ...
    currentStatusAndCauses: [
      { required: true, message: "现状及要因 不能为空", trigger: "blur" }
    ],
    target: [
