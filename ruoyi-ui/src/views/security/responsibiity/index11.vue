<template>
    <div class="app-container">
      ...
      <el-table v-loading="loading" :data="ThreeEducatiomList" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
          <template #default="scope">
            <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['security:ThreeEducatiom:edit']">修改</el-button>
            <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['security:ThreeEducatiom:remove']">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
  ...
  import { listThreeEducatiom, getThreeEducatiom, delThreeEducatiom, addThreeEducatiom, updateThreeEducatiom } from "@/api/security/ThreeEducatiom";
