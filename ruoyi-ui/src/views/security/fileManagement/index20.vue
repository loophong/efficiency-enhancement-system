<template>
  <div class="app-container">
    ...
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="检查时间" prop="year">
        <el-input
      ...
      <el-form-item label="危化品检查记录" prop="text">
        <el-input
          v-model="queryParams.text"
          placeholder="请输入危化品检查记录"
          clearable
          @keyup.enter="handleQuery"
        />
      </el-form-item>
...
<!-- 多文件上传区域 -->
    ...
    <el-table v-loading="loading" :data="filemanagementList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="检查时间" align="center" prop="year" />
      <el-table-column label="危化品检查记录" align="center" prop="text" />
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="filemanagementRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="检查时间" prop="year">
          <el-input v-model="form.year" placeholder="请输入查时间" />
        </el-form-item>
        <el-form-item label="危化品检查记录" prop="text">
          <el-input v-model="form.text" type="textarea" placeholder="请输入危化品检查记录" />
        </el-form-item>
