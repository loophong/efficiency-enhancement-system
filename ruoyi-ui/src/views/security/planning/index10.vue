      ...
      <template #footer>
        <div class="dialog-footer">
          ...
          <el-button @click="cancel">取 消</el-button>
            ...
            <!-- 文件上传弹窗 -->
    <el-dialog title="受控文件发放目录" v-model="uploadDialogVisible" width="35%" @close="resetUpload">
      <el-form :model="form" ref="form" label-width="90px">
        <el-form-item label="上传表类：">
          <span style="color: rgb(68, 140, 39);">受控文件发放目录</span>
          <br>
        </el-form-item>
...
import { listControlleddirectory, getControlleddirectory, delControlleddirectory, addControlleddirectory, updateControlleddirectory ,importFile} from "@/api/security/controlleddirectory";
