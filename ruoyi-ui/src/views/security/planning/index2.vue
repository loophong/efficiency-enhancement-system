...
import {
  listUnacceptablerisklist,
  getUnacceptablerisklist,
  delUnacceptablerisklist,
  addUnacceptablerisklist,
  updateUnacceptablerisklist
} from "@/api/security/unacceptablerisklist";
