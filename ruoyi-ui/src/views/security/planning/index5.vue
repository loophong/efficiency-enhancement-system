      ...
      <template #footer>
        <div class="dialog-footer">
          ...
          <el-button @click="cancel">取 消</el-button>
            ...
            <!-- 文件上传弹窗 -->
    <el-dialog title="安全因素清单" v-model="uploadDialogVisible" width="35%" @close="resetUpload">
      <el-form :model="form" ref="form" label-width="90px">
        <el-form-item label="上传表类：">
          <span style="color: rgb(68, 140, 39);">安全因素清单</span>
          <br>
        </el-form-item>
...
import { listRegulationsIdentificationList1, getRegulationsIdentificationList1, delRegulationsIdentificationList1, addRegulationsIdentificationList1, updateRegulationsIdentificationList1,importFile } from "@/api/security/RegulationsIdentificationList1";
