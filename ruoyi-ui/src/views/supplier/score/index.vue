  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="100px">
      ...
      <el-form-item label="不符合项2" prop="notTrue2">
        <el-input
          v-model="queryParams.notTrue2"
          placeholder="请输入不符合项2"
          clearable
          @keyup.enter="handleQuery"
        />
      </el-form-item>
      <el-form-item label="不符合项3" prop="notTrue3">
        <el-input
          v-model="queryParams.notTrue3"
          placeholder="请输入不符合项3"
          clearable
          @keyup.enter="handleQuery"
        />
      </el-form-item>
      <el-form-item label="不符合项4" prop="notTrue4">
        <el-input
          v-model="queryParams.notTrue4"
          placeholder="请输入不符合项4"
          clearable
          @keyup.enter="handleQuery"
        />
      </el-form-item>
      <el-form-item label="不符合项5" prop="notTrue5">
        <el-input
          v-model="queryParams.notTrue5"
          placeholder="请输入不符合项5"
          clearable
          @keyup.enter="handleQuery"
        />
      </el-form-item> -->
