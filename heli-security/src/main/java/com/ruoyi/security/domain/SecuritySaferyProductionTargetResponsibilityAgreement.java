...
/**
 * 安全生产目标责任书对象 security_safery_production_target_responsibility_agreement
 * 
 * @author wang
 * @date 2025-03-12
 */
public class SecuritySaferyProductionTargetResponsibilityAgreement extends BaseEntity
{
