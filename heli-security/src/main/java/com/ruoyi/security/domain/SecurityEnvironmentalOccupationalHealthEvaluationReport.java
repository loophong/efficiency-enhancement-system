...
/**
 * 环境职业健康安全绩效评价报告对象 security_environmental_occupational_health_evaluation_report
 * 
 * @author wang
 * @date 2025-03-12
 */
public class SecurityEnvironmentalOccupationalHealthEvaluationReport extends BaseEntity
{
