...
/**
 * 环境职业健康安全管理评审报告对象 security_environmental_occupational_health_management_report
 * 
 * @author wang
 * @date 2025-03-12
 */
public class SecurityEnvironmentalOccupationalHealthManagementReport extends BaseEntity
{
