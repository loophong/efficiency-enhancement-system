...
/**
 * 环境职业健康安全管理评审会议记录对象 security_environmental_occupational_health_management_meeting
 * 
 * @author wang
 * @date 2025-03-12
 */
public class SecurityEnvironmentalOccupationalHealthManagementMeeting extends BaseEntity
{
