...
/**
 * 环境职业健康安全管理评审计划对象 security_environmental_occupational_health_management_plan
 * 
 * @author wang
 * @date 2025-03-12
 */
public class SecurityEnvironmentalOccupationalHealthManagementPlan extends BaseEntity
{
