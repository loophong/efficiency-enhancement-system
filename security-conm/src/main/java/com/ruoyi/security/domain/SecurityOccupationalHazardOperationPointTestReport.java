...
/**
 * 职业危害作业点检测报告对象 security_occupational_hazard_operation_point_test_report
 * 
 * @author wang
 * @date 2025-03-11
 */
public class SecurityOccupationalHazardOperationPointTestReport extends BaseEntity
{
