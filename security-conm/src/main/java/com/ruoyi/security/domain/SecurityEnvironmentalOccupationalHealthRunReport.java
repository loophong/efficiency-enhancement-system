...
/**
 * 环境职业健康安全管理体系运行报告对象 security_environmental_occupational_health_run_report
 * 
 * @author wang
 * @date 2025-03-12
 */
public class SecurityEnvironmentalOccupationalHealthRunReport extends BaseEntity
{
