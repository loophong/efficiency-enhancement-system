...
/**
 * 职业危害作业点检测报告对象 security_occupational_hazard_work_point_Inspection_report
 * 
 * @author wang
 * @date 2025-03-12
 */
public class SecurityOccupationalHazardWorkPointInspectionReport extends BaseEntity
{
